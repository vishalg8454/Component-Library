These changes were done as part of the revision comment received ```-- Resubmit with valid github link which has comments.md file -- Mention new components added in comments.md```
